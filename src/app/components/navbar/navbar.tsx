...
function Navbar() {
  ...
  return (
    <div className="sticky top-0 flex flex-col">
      {/* Main navigation bar */}
      <div className="px-5 py-0 flex justify-center bg-old-lace border-b border-cutty-sark border-opacity-10 z-10 h-16">
        <div className="flex flex-row justify-between w-full lg:w-10/12">
          ...
          {/* Links */}
          <div className="hidden lg:flex items-center space-x-8 text-tiber text-sm">
      ...
      <div className={`transform ${ showDrawer ? "translate-y-0 visible" : "-translate-y-96 invisible"} transition-all duration-500 ease-in-out`}>
        <div className="absolute lg:visible w-full bg-old-lace border-b border-cutty-sark border-opacity-10">
