...
const itemsNeeded = [
  ...
  },
  {
    label: '1,900 THB.',
    description:
      'There’s a fee of 1,900 Thai Baht for the extension, which must be paid in cash—no other payment methods are accepted. I personally brought 2,000 THB and received 100 THB back in change.',
  },
  {
    label: 'Your photograph.',
    description:
      'You’ll need a physical photo of yourself (digital won’t work), similar to the one used in your passport. The required size is 4 cm x 6 cm. You can get one at a local photography store, or there may be a service near the immigration office. I chose a local store, paid 100 THB for four photos, and waited about 30 minutes.',
  },
  {
    label: 'Passport photocopies.',
    description:
      'You’ll need two photocopies: one of the photo/personal details page in your passport and one of the page with your entry stamp. Like with your photo, you can get these at a local shop or near the immigration office. I went to a local store, and the two copies cost me 4 THB.',
  },
  {
    label: 'Application form.',
    description:
      'You’ll fill out the application form in person at the immigration office. It’s made up of three parts (three separate documents). Be prepared to provide your address in Thailand, phone number (Thai if you have one), your date and port of arrival, and basic personal details—though I imagine most of this won’t require much preparation. I also recommend bringing your own pen, just in case.',
  },
]
...
const processSteps = [
  {
    label: 'Queue card.',
    description:
      'The first step is to present your application form along with all the required documents to an immigration assistant, who will be easy to spot at a desk. They’ll do a quick pre-check of your paperwork to make sure everything is filled out correctly. If everything looks good, you’ll be handed a queue card—a numbered card to hold your place in line.',
  },
  {
    label: 'Document check.',
    description:
      'Once you’ve got your queue card, head to the area where they’re calling out the numbers. When yours is called, go to the assigned desk and hand over your application form and documents. The immigration assistant will review your paperwork, ask you to pay the 1,900 THB fee, and take your picture with the webcam at their desk. You’ll also need to hand over your passport, which you won’t get back until the final step, but do make sure to keep your queue card.',
  },
  {
    label: 'Visa processing.',
    description:
      'After completing the document check, head to the waiting area. The wait time will depend on how many people are ahead of you in the queue. While you’re waiting, the immigration department will process your details and paperwork to prepare your visa extension.',
  },
  {
    label: 'Passport return.',
    description:
      'When your number is called again, you’ll be given back your passport along with a physical document confirming your extension and payment. Inside your passport, you’ll find an update to your original arrival stamp with a new date—usually 30 days beyond the end of your initial stay.',
  },
]
  ...
  return (
    <main className="flex-grow">
      <article>
        ...
        <BackToBlog>
          <BackToBlogButton>Back to blog</BackToBlogButton>
        </BackToBlog>
        <ContentContainer className="py-8">
          <IntroductionSection>
            <IntroductionHeading>Thailand: How to Extend a Tourist Visa by 30 Days</IntroductionHeading>
            <IntroductionDate>September 26, 2024</IntroductionDate>
            <IntroductionBody>
          ...
          <WhatYouNeedSection>
            <WhatYouNeedHeading>What You Need</WhatYouNeedHeading>
            <WhatYouNeedChecklist>
          ...
          <WhereToGoSection>
            <WhereToGoHeading>Where to go</WhereToGoHeading>
            <WhereToGoBody>
              <span>
                ...
                different province and planned to stay there for their entire trip. Based on this, I recommend visiting
                the immigration office in the province where you plan to stay if you’re in a similar situation.
                {'\n'}
                {'\n'}
                ...
                <WhereToGoLink href="https://maps.app.goo.gl/dqNeEgV4n6CV31sH7">IT Square</WhereToGoLink>, listed on
                Google Maps as “Immigration Office - Short-term VISA”.
                {'\n'}
                {'\n'}
          ...
          <WhatToExpectSection>
            <WhatToExpectHeading>What to expect</WhatToExpectHeading>
            <WhatToExpectBody>
          ...
          <FinalCommentsSection>
            <FinalCommentsHeading>Final comments</FinalCommentsHeading>
            <FinalCommentsBody>
              ...
              {'\n'}
              {'\n'}
              If you think something’s missing or have suggestions for improving this article, please reach out to me at{' '}
              <FinalCommentsLink href="mailto:max@hvesserlewis.com">max@hvesserlewis.com</FinalCommentsLink>—I’d be glad
              to hear from you.
            </FinalCommentsBody>
          </FinalCommentsSection>
        </ContentContainer>
