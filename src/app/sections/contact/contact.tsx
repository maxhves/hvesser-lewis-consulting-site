  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row space-x-0 lg:space-x-12 space-y-8 lg:space-y-0">
        ...
        <div className="w-full lg:w-1/2 space-y-2 text-cutty-sark dark:text-aths-special">
          <input
          ...
          <div className="flex justify-end">
            <button
              type="button"
              className="bg-jungle-green py-4 px-6 rounded-xl text-old-lace dark:text-daintree active:bg-tiber w-full lg:w-fit border-daintree dark:border-old-lace border-opacity-10 dark:border-opacity-10 border-2"
            >
              Get in touch
            </button>
          </div>
