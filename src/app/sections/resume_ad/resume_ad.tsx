          ...
          <div className="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-8">
            ...
            <div className="flex flex-row space-x-4">
              ...
              <div className="flex flex-col space-y-1">
                <p className="text-old-lace font-bold text-2xl">CHECKOUT MY RESUME</p>
                <p className="text-aths-special font-medium">To see all of my past work and education, take a look at my resume</p>
              </div>
            </div>
