...
function ResumeAd() {
  return (
    <SectionWrapper>
      <div className="bg-aths-special dark:bg-daintree p-6 w-full flex flex-col md:flex-row items-center space-y-8 md:space-y-0 space-x-0 md:space-x-8 rounded-3xl border-daintree dark:border-aths-special border-2 border-opacity-5 dark:border-opacity-10">
        <Image
          className="h-20 w-20"
